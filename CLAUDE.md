...
| 시점 | 훅 수 | 주요 기능 |
|------|-------|-----------|
| PreToolUse | 6 | dev server tmux 강제, 장기 작업 tmux 리마인더, push 전 리뷰 리마인더, .md 작성 경고, compaction 제안, continuous-learning 관찰 |
| PostToolUse | 6 | PR URL 로깅, 빌드 완료 분석, auto-format, typecheck, console.log 경고, continuous-learning 관찰 |
| PreCompact | 1 | 상태 저장 |
...
check-console-log.js, doc-file-warning.js, evaluate-session.js, post-edit-console-warn.js, post-edit-format.js, post-edit-typecheck.js, pre-compact.js, session-end.js, session-start.js, suggest-compact.js
