...
```
// 색상 하드코딩
Grep("#[0-9a-fA-F]{3,8}", glob="**/*.{tsx,jsx,vue}")
Grep("rgb\\(|rgba\\(|hsl\\(", glob="**/*.{tsx,jsx,vue,css}")

// Tailwind arbitrary value
Grep("text-\\[|bg-\\[", glob="**/*.{tsx,jsx,vue}")
Grep("p-\\[|px-\\[|py-\\[|pt-\\[|pr-\\[|pb-\\[|pl-\\[", glob="**/*.{tsx,jsx,vue}")
Grep("m-\\[|mx-\\[|my-\\[|mt-\\[|mr-\\[|mb-\\[|ml-\\[", glob="**/*.{tsx,jsx,vue}")
Grep("w-\\[|h-\\[|gap-\\[|rounded-\\[|z-\\[", glob="**/*.{tsx,jsx,vue}")
