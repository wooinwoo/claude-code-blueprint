...
```
/research <topic>                  → 일반 주제 리서치 (market-researcher)
...
/research --competitor <company>   → 경쟁사 분석 (기능, 가격, 리뷰)
```
...
const methodology = {
  ...
  "--competitor": {
    agent: "market-researcher",
    focus: "경쟁사 기능, 가격, 포지셔닝, 사용자 평가",
    output_sections: ["경쟁사 개요", "기능 비교", "가격 비교", "사용자 평가", "차별화 기회"]
  },
  "default": {
    agent: "market-researcher",
    focus: "주제 전반 조사",
...
if (flag === "--market" || flag === "--competitor" || flag === "--tech" || !flag) {
  ...
  analysis = Agent("market-researcher", `
...
```
→ 시장 규모/성장률/주요 플레이어 검색 → market-researcher 분석 → plans/research-hr-saas-2026-03-14.md
...
```
→ 채택률/비교/사례 검색 → market-researcher 분석 → plans/research-graphql-2026-03-14.md

### 예시 4: 경쟁사 분석
```
/research --competitor "Workday"
```
→ 기능/가격/리뷰 검색 → market-researcher 분석 → plans/research-workday-2026-03-14.md

### 예시 5: 일반 리서치
```
/research "AI 기반 채용 자동화"
```
→ 전반 조사 검색 → market-researcher 분석 → plans/research-ai-기반-채용-자동화-2026-03-14.md
